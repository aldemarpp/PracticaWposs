					...
					<Paper className={classes.paper}>
						<div className={classes.root}>
							<Tabs value={value} onChange={handleChange} indicatorColor="primary" textColor="primary">
								...
								<Tab label="Nueva Transaccion" {...a11yProps(1)} />
							</Tabs>
							<SwipeableViews
							...
							>
								<TabTransaccion value={value} index={0}>
									<Transaccion onChangeIndex={onChangeIndex} />
								</TabTransaccion>
								<TabTransaccion value={value} index={1}>
									<NuevaTransaccion data={data} />
								</TabTransaccion>
							</SwipeableViews>
						</div>
					</Paper>
